...
class DoubleFetchChecker : public DFA, public llvm::ModulePass
{
...
public:
    ...
    DoubleFetchChecker(char id = ID): ModulePass(ID) {}
    virtual ~DoubleFetchChecker() {}
    ...
    virtual llvm::StringRef getPassName() const {
        return "DoubleFetchChecker using SVF";
    }
